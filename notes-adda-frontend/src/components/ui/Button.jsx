...
export const Button = ({ children, onClick, variant = 'primary', className = '', icon: Icon, disabled = false }) => {
  ...
  const variants = {
    primary: "bg-gradient-to-r from-violet-600 to-indigo-600 text-white hover:shadow-indigo-500/30 hover:brightness-110 border border-indigo-500/20",
    secondary: "bg-white/10 backdrop-blur-md border border-white/20 text-white hover:bg-white/20",
    danger: "bg-red-500/20 border border-red-500/30 text-red-200 hover:bg-red-500/30",
    ghost: "text-slate-300 hover:text-white hover:bg-white/5 shadow-none",
